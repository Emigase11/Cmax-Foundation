...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const fixed = ["", "/approach", "/about/press", "/our-work", "/our-actions", "/campaigns", "/global-advocacy", "/global-advocacy/united-nations", "/about", "/about/team", "/about/transparency", "/support"];
  return [
